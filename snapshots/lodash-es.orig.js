...
var symbolProto$1 = Symbol$1 ? Symbol$1.prototype : undefined, symbolToString = symbolProto$1 ? symbolProto$1.toString : undefined;
/**
...
function createFlow(fromRight) {
	return flatRest(function(funcs) {
		...
		while (++index < length) {
			func = funcs[index];
			var funcName = getFuncName(func), data = funcName == "wrapper" ? getData$1(func) : undefined;
...
function fn(input) {
	return flowRight$1([(x) => filter(x, isOdd), (x) => range$1(2, x)])(input);
}
