			...
			*/
			var runInContext = function runInContext(context) {
				...
				*/
				...
				var Buffer = context.Buffer, Symbol = context.Symbol, Uint8Array = context.Uint8Array, allocUnsafe = Buffer ? Buffer.allocUnsafe : void 0, getPrototype = overArg(Object.getPrototypeOf, Object), objectCreate = Object.create, propertyIsEnumerable = objectProto.propertyIsEnumerable, splice = arrayProto.splice, spreadableSymbol = Symbol ? Symbol.isConcatSpreadable : void 0, symIterator = Symbol ? Symbol.iterator : void 0, symToStringTag = Symbol ? Symbol.toStringTag : void 0;
				...
				*/
				function lazyValue() {
					var array = this.__wrapped__.value(), dir = this.__dir__, isArr = isArray(array), isRight = dir < 0, arrLength = isArr ? array.length : 0, view = getView(0, arrLength, this.__views__), start = view.a, end = view.b, length = end - start, index = isRight ? end : start - 1, iteratees = this.__iteratees__, iterLength = iteratees.length, resIndex = 0, takeCount = nativeMin(length, this.__takeCount__);
				...
				*/
				function hashDelete(key) {
					var result = this.has(key) && (delete this.__data__[key], true);
				...
				*/
				function Stack() {
					var data = this.__data__ = new ListCache(void 0);
					this.size = data.size;
				}
				/**
				...
				*/
				function baseInverter(object, setter, iteratee, accumulator) {
					baseForOwn(object, function(value, key) {
						setter(accumulator, iteratee(value), key);
					});
					return accumulator;
				}
				/**
				...
				function baseIsMatch(object, source, matchData, customizer) {
					...
					while (++index < length) {
						...
						if (noCustomizer && data[2]) {
							...
							if (!(result === void 0 ? baseIsEqual(srcValue, objValue, 3, customizer, stack) : result)) {
								return false;
							}
						}
					}
				...
				*/
				function baseMatches(source) {
					...
					return function(object) {
						return object === source || baseIsMatch(object, 0, matchData);
					};
				}
				/**
				...
				*/
				function baseMatchesProperty(path, srcValue) {
					...
					return function(object) {
						...
						return objValue === void 0 && objValue === srcValue ? hasIn(object, path) : baseIsEqual(srcValue, objValue, 3);
					};
				}
				/**
				...
				*/
				function baseUnset(object, path) {
					path = castPath(path, object);
					object = parent(object, path);
					return object == null || (delete object[toKey(last(path))], true);
				}
				/**
				...
				*/
				function createHybrid(func, bitmask, thisArg, partials, holders, partialsRight, holdersRight, argPos, ary, arity) {
					var isAry = bitmask & 128, isBind = bitmask & 1, isBindKey = bitmask & 2, isCurried = bitmask & 24, isFlip = bitmask & 512, Ctor = isBindKey ? void 0 : createCtor(func);
					function wrapper() {
				...
				*/
				function createRecurry(func, bitmask, wrapFunc, placeholder, thisArg, partials, holders, argPos, ary, arity) {
					var isCurry = bitmask & 8, newHolders = isCurry ? holders : void 0, newHoldersRight = isCurry ? void 0 : holders, newPartials = isCurry ? partials : void 0, newPartialsRight = isCurry ? void 0 : partials;
				...
				*/
				function createWrap(func, bitmask, thisArg, partials, holders, argPos, ary, arity) {
					...
					} else if ((bitmask == 32 || bitmask == 33) && !holders.length) {
 ...
 // Coerce regexes to strings and treat strings, primitives and objects,
				...
				*/
				function equalObjects(object, other, bitmask, customizer, equalFunc, stack) {
					var isPartial = bitmask & 1, objProps = getAllKeys(object), objLength = objProps.length, othProps = getAllKeys(other), othLength = othProps.length;
				...
				*/
				function initCloneByTag(object, tag, isDeep) {
					...
					switch (tag) {
						...
						case "[object Map]": return new Ctor();
						case numberTag:
				...
				*/
				function mergeData(data, source) {
					var bitmask = data[1], srcBitmask = source[1], newBitmask = bitmask | srcBitmask, isCommon = newBitmask < 131;
					var isCombo = srcBitmask == 128 && bitmask == 8 || srcBitmask == 128 && bitmask == 256 && data[7].length <= source[8] || srcBitmask == 384 && source[7].length <= source[8] && bitmask == 8;
				...
				*/
				function ary(func, n, guard) {
					...
					return createWrap(func, 128, void 0, void 0, 0, void 0, n);
				}
				/**
				...
				*/
				function curry(func, arity, guard) {
					...
					var result = createWrap(func, 8, void 0, void 0, 0, void 0, void 0, arity);
				...
				*/
				function curryRight(func, arity, guard) {
					arity = guard ? void 0 : arity;
					var result = createWrap(func, 16, void 0, void 0, 0, void 0, void 0, arity);
				...
				*/
				function debounce(func, wait, options) {
					...
					if (isObject(options)) {
						...
						maxWait = maxing ? nativeMax(toNumber(options.maxWait) || 0, wait) : void 0;
				...
				*/
				var rearg = flatRest(function(func, indexes) {
					return createWrap(func, 256, void 0, void 0, 0, indexes);
				});
				/**
				...
				*/
				function isMatch(object, source) {
					return object === source || baseIsMatch(object, 0, getMatchData(source));
				}
				/**
				...
				*/
				function toArray(value) {
					...
					var tag = getTag(value), func = tag == "[object Map]" ? mapToArray : tag == "[object Set]" ? setToArray : values;
					return func(value);
				}
				/**
				...
				*/
				function truncate(string, options) {
					...
					if (isObject(options)) {
						var separator = "separator" in options ? options.separator : void 0;
						length = "length" in options ? toInteger(options.length) : 30;
...
function fn() {
	return _.flowRight([(x) => _.filter(x, isOdd), (x) => _.range(2, x)])(10);
}
console.log(fn().join(","));
