...
async function Executar() {
            ...
            if (CodigoDaRodada != codigoOriginal) {
                ...
                if ( (resultadoFinal.Chars < resultadoOriginal.Chars || resultadoFinal.Instructions < resultadoOriginal.Instructions)) {
                    ...
                    if (fs.existsSync(caminhoArquivoCVSRodada)) {
                        ...
                        fs.writeFileSync(caminhoArquivoCVSRodada, fileContents);
                        var loader = require('csv-load-sync');
                        var csv = loader(caminhoArquivoCVSRodada, {
                            getColumns: split
                        });;
                    ...
                    console.log(`   Não melhorou em relação ao original.`);
                }
    ...
    EscreverResultadoEmCsv(DiretorioResultados, resultadosProcessadosDeTodos, 'Resultados_paper.csv');
