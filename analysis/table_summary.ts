...
function generateLatexTable(results: BenchmarkResult[], geometricMean: number): string {
  ...
  latex += '\\toprule\n';
  latex += '\\multirow{2}{*}[-0.5ex]{Project} & \\multirow{2}{*}[-0.5ex]{\\#FunDef} & \\multirow{2}{*}[-0.5ex]{\\#AbsInst} & \\multirow{2}{*}[-0.5ex]{\\#Calls} & \\multicolumn{3}{c}{Retrieval (\\%)} & \\multicolumn{3}{c}{Generation (\\%)} & \\multicolumn{2}{c}{Time (ms)} & \\multirow{2}{*}[-1ex]{\\makecell[r]{Speedup\\\\($\\times$)}} \\\\\n';
